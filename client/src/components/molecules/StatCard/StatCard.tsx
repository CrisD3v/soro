...
export const StatCard = ({
  ...
  return (
    <motion.div
      ...
      className={`relative p-6 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all overflow-hidden ${className}`}
    >
      {/* Gradient Background */}
